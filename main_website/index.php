						...
						<div class="home_slider_content text-center">
							<div class="home_slider_content_inner" data-animation-in="flipInX" data-animation-out="animate-out fadeOut">
								...
								<div class="button home_slider_button">
									<div class="button_bcg"></div><a href="buses.php">explore now<span></span><span></span><span></span></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row fill_height">
					<div class="col fill_height">
						...
						<div class="search_panel active">
							<form action="#" method="post"  id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
								<div class="search_item">
									<div>From Destination</div>
									<input type="text" id="from_location" name="from_location" class="destination search_input" >
								</div>
								<div class="search_item">
			...
			<div class="container">
				...
				<div class="row intro_items">
					...
					if (isset($_POST['submit'])) {
						...
						$query = "SELECT * FROM  available_bus  WHERE from_location LIKE '$from_location' AND to_location LIKE '$to_location'  OR from_date LIKE '$from_date'  OR  bus_time LIKE '$bus_time' ";
						...
						if (mysqli_num_rows($result) > 0) {
								...
								<div class="col-lg-4 intro_col">
									<div class="intro_item">
										...
										<div
											...
											<div class="intro_date"><?php echo $row['from_location'] ?> -- >
												<?php echo $row['to_location'] ?></div>
											<div class="button intro_button">
												<div class="button_bcg text-white"></div><a
													href="book_bus.php?bus=<?php echo $row['id'] ?>" name="book"
													id="book">Book<span></span><span></span><span></span></a>
											</div>
											<div class="intro_center text-center">
												<h3 class="text-white"><?php echo $row['bus_no'] ?></h3>
												<input type="hidden" class="text-white" id="id" value="<?php echo $row['id'] ?>">
												<h1 class="text-warning"><?php echo $row['bus_name'] ?></h1>
												<h4><?php echo $row['from_date'] ?></h4>
												<div class="intro_price"><?php echo $row['bus_seat_price'] ?>/-</div>
							...
							echo "<script>swal('Destination Bus Not found', 'Re-enter your root !', 'error');</script>";
						}
						;
					}
					?>
