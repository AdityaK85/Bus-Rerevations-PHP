...
<head>
	...
	<link rel="stylesheet" href="newCss/assets/css/app.min.css" />
	<link rel="stylesheet" href="newCss/assets/css/style.css" />
	<link rel="stylesheet" href="newCss/assets/css/components.css" />
...
<body>
	...
	<div class="super_container">
					...
					<div class="row">
						<div class="col d-flex flex-row">
							...
							<div class="user_box ml-auto">
								...
								<div id="signOut" class="user_box_login user_box_link"><a href="destroy_ses.php" name="signOut">Sign
										Out</a></div>
		...
		<script>
			...
			if (ses == "") {
				swal("Login First", "Find Your Trip Here !", "error").then(function(){
