...
if (isset($_POST['submit'])) {
  ...
  $query = "SELECT * FROM  admin_login  WHERE user_email = '$email_id' AND password = '$password' ";
          ...
          <form action="#" method="post">
            <div class="form-group">
              ...
              <div class="position-relative has-icon-right">
                <input type="text" id="user_email" name="user_email" class="form-control input-shadow" placeholder="Enter Username">
